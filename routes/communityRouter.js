...
router.post("/create", authMiddleware, upload.single("cIcon"), async function (req, res) {
    try {
        ...
        // const [insertCommunity] = await pool.query(" INSERT INTO communities (community_name,normalizedCommunitySlug,community_icon_url,community_rules,community_slug,normalized_slug,community_admin_id,community_description")
